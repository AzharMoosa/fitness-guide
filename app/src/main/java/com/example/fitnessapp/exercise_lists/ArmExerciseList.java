...
public class ArmExerciseList extends AppCompatActivity {
  ...
  private LinearLayout armExerciseList;

  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.activity_arm_exercise_list);
    armExerciseList = findViewById(R.id.arm_exercises_list);
    getArmExercises();
  }
  ...
  private void getArmExercises() {
    ApiUtilities.getApiInterface()
      ...
      public void onFailure(Call<List<ExerciseData>> call, Throwable t) {
        Toast.makeText(getApplicationContext(), "Cannot Get Arm Exercises", Toast.LENGTH_SHORT).show();
      }
    });
  }
